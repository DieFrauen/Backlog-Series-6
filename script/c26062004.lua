...
function c26062004.spcon(e,c)
	...
	local g1=Duel.GetMatchingGroup(c26062004.dcost,tp,LOCATION_HAND+LOCATION_ONFIELD,0,e:GetHandler())
...
function c26062004.grop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		if tc:GetLevel()+1~=2 and Duel.SelectYesNo(tp,aux.Stringid(26062004,1)) then
			local e1=Effect.CreateEffect(c)
