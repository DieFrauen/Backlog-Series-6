...
function c26065010.filter(c)
	return c:IsSummonable(true,nil) and c:IsSetCard(0x665)
end
...
function c26065010.gtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local s1=Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and
		  Duel.IsExistingMatchingCard(c26065010.filter,tp,LOCATION_HAND,0,1,nil)
